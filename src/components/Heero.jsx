    ...
    <div >
        ...
        <div className="justify-center items-center text-center space-y-8 mt-10 px-6 ">
            ...
            <div className=" cube animate-rotateCube mx-auto justify-center items-center hidden dark:block ">
                <img className="face front w-1/2 animate-flip3d rounded-md  " src="src/assets/3D.png" href="src/assets/3D.png" alt="front" />
                <img className="face back w-1/2 animate-flip3d rounded-md " src="src/assets/3D.png" alt="back" />
                <img className="face right w-1/2 animate-flip3d rounded-md  " src="src/assets/3D.png" alt="right" />
                <img className="face left w-1/2 animate-flip3d rounded-md " src="src/assets/3D.png" alt="left" />
            </div>
